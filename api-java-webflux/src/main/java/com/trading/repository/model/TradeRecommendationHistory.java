...
/**
 * This class is meant to serve as historical data for Trade recommendations at the instant they are
 * made. The Document key should give insight as to when the recommendation was made and is a
 * composite key of <Ticker>-<Timestamp>
 */
@Data
